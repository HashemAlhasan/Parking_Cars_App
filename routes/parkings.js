...
import { addParking,bookingPark,ParkingTimer,ExpandParkingTime ,HomeParkingTimer} from "../controllers/booking.js";
...
router.route('/HomeParkingTimer').post(HomeParkingTimer)
